...
export const I18N = {
  ar: {
    ...
    char_title: "شخصيات العلامة (عُمانية أصيلة)", char_hint: "شخصية عُمانية حقيقية بالمصر أو الكمة — عند اختيارها تُستخدم كخلفية كاملة في كل تصاميم قالب «الحضور».", char_needspotlight: "فعّل قالب «الحضور» (spotlight) أعلاه ليظهر تأثيرها.", char_use: "استخدم هذه الشخصية", char_saved: "تم اعتماد الشخصية", char_none: "بدون شخصية", char_none_d: "قالب الحضور يستخدم صورة موضوعية عامة بدل الشخصية.",
  ...
  fa: {
    ...
    char_title: "شخصیت‌های برند (عُمانی اصیل)", char_hint: "یک فرد عُمانی واقعی با مصر یا کمه — با انتخاب، پس‌زمینه کامل همه طرح‌های Spotlight می‌شود.", char_needspotlight: "قالب Spotlight را بالا فعال کنید.", char_use: "این شخصیت", char_saved: "شخصیت انتخاب شد", char_none: "بدون شخصیت", char_none_d: "Spotlight از عکس موضوعی عمومی استفاده می‌کند.",
