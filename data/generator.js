...
{"t":"<السطر الرئيسي للعنوان (يُرسم خمري) — قصير صادم>","t2":"<سطر ثانٍ مكمّل يُرسم برتقالي (نمط العنوان الأصلي ثنائي اللون) — أو \"\">","cta":"<عبارة حث قصيرة ≤4 كلمات تُرسم كحبة مائلة مثل «احفظها قبل لا تبدأ» — أو \"\">","cap":"<كابشن محدّث>","brief":"<بريف تصميم>","photo":"<٢-٤ كلمات إنجليزية تصف صورة خلفية موضوعية مناسبة إن طلب المالك صورة أو كانت تناسب الموضوع — مثل: perfume shop retail / omani small business / online store packaging / cashier point of sale — أو اتركها فارغة \"\" إن كانت بطاقة نصية أنسب>","slides":[<إن كان نوع المنشور «كاروسيل» اجعلها ٤-٦ شرائح محتوى (بعد الغلاف)، كل عنصر {"t":"عنوان الشريحة","body":"سطر أو سطران"}؛ وإلا اتركها []>],"scenes":[<إن كان النوع «ريل» اجعلها ٣ مشاهد فيديو متتابعة: المشهد ١ هوك قصير صادم، المشهد ٢ القيمة/التشويق، المشهد ٣ ختام «قريبًا» — كل عنصر {"t":"سطر المشهد (٦ كلمات أو أقل)","body":"سطر داعم موجز أو \"\"","kicker":"سطر تمهيدي صغير أو \"\"}؛ وإلا اتركها []>]}`;
